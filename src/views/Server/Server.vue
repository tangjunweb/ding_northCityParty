<template>
  <div class="main">
    <Homeheader>
      <img class="header-title" src="@/assets/dj-server.png" alt />
    </Homeheader>
    <div class="analysis">
      <div class="left">
        <!-- 汇总 -->
        ...
        <!-- 资源分布 -->
        <div class="box marginBottom" style="height:182px;">
          <div class="humbings-count boll-cxt">
            <div class="upload-title">资源分布</div>
            <div class="echartbox">
              <Piechart :pieData="resorcedata"></Piechart>
            </div>
          </div>
        </div>
        <!-- 需求分布 -->
        <div class="box marginBottom" style="height:182px;">
          <div class="humbings-count boll-cxt">
            <div class="upload-title">需求分布</div>
            <div class="echartbox">
                <Piechart :pieData="resorcedata"></Piechart>
            </div>
          </div>
        ...
        <div class="box marginBottom" style="height:182px;">
          <div class="humbings-count boll-cxt">
            <div class="upload-title">任务分布</div>
            <div class="echartbox">
                <Piechart :pieData="resorcedata"></Piechart>
            </div>
          </div>
      ...
      <div class="center">
        ...
        <div class="box boll-cxt" style="height:291px;position:relative">
          <div class="upload-title">最近正在进行的10个任务</div>
          <!-- <div class="tab">
      ...
      <div class="right">
        ...
        <div class="box marginBottom" style="height:278px;">
          <div class="humbings-count boll-cxt">
            <div class="upload-title">党建资源全区区域分布</div>
        ...
        <div class="box marginBottom" style="height:278px;">
          <div class="humbings-count boll-cxt">
            <div class="upload-title">服务资源全区区域分布</div>
            <div class="upload-organazie">
              <echartBar :renderData="adoptorganazie"></echartBar>
            </div>
          </div>
        ...
        <div class="box marginBottom" style="height:291px;">
          <div class="humbings-count boll-cxt">
            <div class="upload-title">创建清单数</div>
            <div class="upload-organazie">
              <echartBar :options="opp" :renderData="alldistrictorganazie"></echartBar>
            </div>
          </div>
        </div>
      </div>
...
<script>
import echartBar from "@/views/organazition/bar";
import echartLine from "@/views/organazition/line";
...
export default {
  ...
  mounted() {
    ...
    this.opp = {
     ...
     this.resorcedata = yuandata.map(e => {
      return {
        name: e.name,
        value: e.value
      };
...
.analysis {
  ...
  .left {
    ...
    .humbings-count {
      ...
      .lab-box {
        width: 260px;
        height: 127px;
        background: url("~@/assets/lab-box-bg-sever.png") left top no-repeat;
  ...
  .boll-cxt {
    // background: url("~@/assets/organazie-box-bg.png") left top no-repeat;
    // background-size: 100% 100%;
    // height: 278px;
  ...
  .center {
    ...
    .cot-list {
      ...
      // margin-bottom: 4px;
      // background: #1f2d59;
      border-bottom: 1px dashed #1f2d59;
      // padding-left: 30px;
      display: flex;
      align-items: center;
      p.title {
